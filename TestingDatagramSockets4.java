/*
TestingDatagramSockets4.java
Specifying Network Interface, ipv6
*/
...
public class TestingDatagramSockets4
{
	final static String NTWK_INTF_NAME = "en0";
	...
	public static void main(String[] args)
	{
		try
		{
			...
			System.out.print("Creating networkInterface: ");
			NetworkInterface networkInterface = NetworkInterface.getByName(NTWK_INTF_NAME);
			System.out.println(networkInterface);

			System.out.println("Joining Multicast Group.");
			ms.joinGroup((SocketAddress) broadcastAddress , networkInterface);
